...
#........background image and logo images path........
    ...
    if login_clicked:
        ...
        if username.strip() == "" or password.strip() == "":
            ...
            try:
                ...
                result = None
        if result: #...check if user exists in database and login successful...
...
with Pass_col: #...forgot password .......
    st.markdown('<p class="main-text">Forgot Password?</p>', unsafe_allow_html=True)
    Forget_pass = st.button("Forget Password", use_container_width=True)
    if Forget_pass:
        st.switch_page("pages/Forgot Password.py") #...switch to forgot password page.........;
...
if Sign_up:
    st.switch_page("pages/Sign up.py") #...switch to signup page.........
