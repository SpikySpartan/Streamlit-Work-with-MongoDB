...
mongodb+srv://Awadhesh:<SwordArtOnine>@cluster0.gbpzk4b.mongodb.net/?appName=Cluster0
...
def get_base64_image(image_path: str) -> str:
    ...
    for candidate in ["images/Login.jpg", "images/Sign.jpg", "images/background.jpg", "images/logo.png"]:
...
def main() -> None:
    ...
    st.markdown("<h2 class='page-title'>Reset Password</h2>", unsafe_allow_html=True)
    st.markdown(
