    ...
    st.markdown(
        ...
        <div class="hero-section">
            ...
            <div class="hero-subtitle" style="margin-top: 12px;">
                This is my first webpage, and I created it using Python and Streamlit. I really enjoyed building it and learning how to design a simple but functional web application. The application page includes useful tools such as number tools, string tools, a calculator, notes, and a quiz, which make the project more interactive and practical.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
